...
class Network:
    ...
    def _init_fields(self) -> None:
        ...
        self._build_func = (
            None  # User-supplied build function that constructs the network.
        )
        self._build_func_name = None  # Name of the build function.
        self._build_module_src = (
            None  # Full source code of the module containing the build function.
        )
    ...
    def run(
        ...
        **dynamic_kwargs
        ...
        out_arrays = [
            np.empty(
                [num_items] + tfutil.shape_to_list(expr.shape)[1:], expr.dtype.name
            )
